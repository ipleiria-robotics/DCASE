...
# A ferramenta utilizada que possibilitou realizar este o aumento designa-se Audiomentations
...
augment1 = Compose([
    ...
    Shift(min_shift=-0.25, max_shift=0.25, p=0.25),
...
X_train, X_validation, Y_train, Y_validation = train_test_split(newData, newData_scene_label, test_size=0.1,random_state=1, stratify=newData_identifier)
