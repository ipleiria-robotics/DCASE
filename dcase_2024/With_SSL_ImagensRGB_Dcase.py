...
def simsiam_augmenterAAA(img, blur=False, area_range=(0.2, 1.0)):
    ...
    * Blur is not applied for the cifar10 dataset.
    ...
    image.save(current_dir+"/"+ "dcase_2024/Dcase_augmenter.jpg")
...
def readCsvImages(csv_file, roor_dir):
    ...
    with open(csv_file) as f:
        ...
        for row in reader:
            ...
            image = tf.io.read_file(roor_dir + file_name[1] + ".png")
            ...
            resized_image_pil.save(current_dir+"/"+ "dcase_2024/UrbanOrigina.jpg")
...
X, Y = readCsvImages(csv_file = current_dir+"/"+ "dcase_2024/fold1_Train.csv", roor_dir = current_dir+"/"+ "dcase_2024/Archive_train/")
...
X_qy = []
Y_qy = []
X_qy, Y_qy = readCsvImages(csv_file = current_dir+"/"+ "dcase_2024/fold1_val.csv", roor_dir = current_dir+"/"+ "dcase_2024/Archive_val/")
...
if ALGORITHM == "simsiam":
    ...
    INIT_LR = 3e-6  # Initial LR for the learning rate schedule.
    WARMUP_STEPS = 1000
